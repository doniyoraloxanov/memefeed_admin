...
export default function ChatView({ users }: { users: User[] }) {
  ...
  const renderHead = (
    ...
    >
      {selectedConversationId ? (
        <>{details && <ChatHeaderDetail participants={users} />}</>
      ) : (
  ...
  const renderMessages = (
    ...
    >
      <ChatMessageList messages={conversation?.messages} participants={users} />
      ...
      <Stack component={Card} direction="row" sx={{ height: '72vh' }}>
        ...
        >
          ...
          >
            ...
            {details && <ChatRoom conversation={conversation} participants={users} />}
          </Stack>
        </Stack>
      </Stack>
    </Container>
